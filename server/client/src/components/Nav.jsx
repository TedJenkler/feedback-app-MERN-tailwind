...
function Nav({ toggleMenu, setToggleMenu }) {
    return (
        <>
            ...
            <nav className='xs:px-4 s:px-6 flex justify-between h-[4.5rem] items-center bg-gradient-to-tr from-gradient-blue via-gradient-purple to-gradient-red md:hidden md:absolute overflow-x-hidden'>
