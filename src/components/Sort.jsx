...
function Sort() {
    ...
    return (
        // Sort component UI
        <div className='flex justify-between h-14 items-center text-white px-6 bg-dark-blue text-sm md:mx-10 md:rounded-xl md:h-20 xl:mt-24 xl:mr-0 xl:ml-8 xl:h-16'>
