...
function NoFeedback() {
  return (
    <div className='flex flex-col bg-white px-6 py-20 mx-6 rounded-xl items-center md:mx-10 md:py-28'>
        ...
        <p className='mb-6 text-grey text-sm font-normal text-center md:mx-32'>Got a suggestion? Found a bug that needs to be squashed? We love hearing about new ideas to improve our app.</p>
