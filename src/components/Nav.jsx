...
function Nav( {toggleMenu, setToggleMenu} ) {
  return (
    <>
    <nav className='hidden absolute md:flex md:relative md:mx-10 md:mb-10 md:h-44 gap-2 xl:flex xl:flex-col xl:pl-40 xl:pr-0 xl:pt-24 xl:gap-6 xl:mr-0 xl:w-1/3'>
      <div className='bg-gradient-to-tr from-gradient-blue via-gradient-purple to-gradient-red pt-24 w-1/3 px-6 rounded-xl xl:w-full xl:p-6 xl:pt-16'>
