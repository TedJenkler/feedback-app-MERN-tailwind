...
function Nav( {toggleMenu, setToggleMenu} ) {
  return (
    <>
    <nav className='hidden absolute md:flex md:relative md:mx-10 md:mb-10 md:h-44 gap-2'>
      <div className='bg-gradient-to-tr from-gradient-blue via-gradient-purple to-gradient-red pt-24 w-1/3 px-6 rounded-xl'>
